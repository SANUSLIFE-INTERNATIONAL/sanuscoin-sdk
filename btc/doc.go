...
/*
btc is a full-node bitcoin implementation written in Go.

The default options are sane for most users.  This means btc will work 'out of
...
parsed when btc starts up.  By default, the configuration file is located at
~/.btc/btc.conf on POSIX-style operating systems and %LOCALAPPDATA%\btc\btc.conf
